-- 20260620010000_fix_rpc_meal_planner.sql
-- Fix cr.protein_multiplier does not exist error
...
BEGIN
    ...
    -- FIX: Use cr.protein_limit_g instead of cr.protein_multiplier * weight
    SELECT 
