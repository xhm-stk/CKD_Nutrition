...
void main() {
  ...
  testWidgets(
    'NutrientCircle displays correct texts and green color for normal level',
  ...
  testWidgets('NutrientCircle displays orange color when near limit', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('NutrientCircle displays red color when over limit', (
    WidgetTester tester,
  ) async {
